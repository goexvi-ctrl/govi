...
printf '%s' "-X govi/engine.versionName=govi-${tag#v} -X govi/engine.commitDate=${commitDate} -X govi/engine.commitHash=${hash} -X govi/engine.treeState=${state} -X govi/engine.buildTime=${buildTime}"
